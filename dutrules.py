...
( ((ATB,), True, True, True, ALL, ALL),
  (ADM, (ADM,), ADJ, None, None, 'Le jury valide le précédent') ),
( ((ATB,), True, False, True, ALL, True),
  (ATT, (ADM, AJ), ADJ, None, None, 'Le jury valide le précédent, pas moyenne gen., attente suivant') ),
( ((ATB,), True, ALL, False, ALL, True),
  (ATB, (ADM, AJ), ADJ, None, None, 'Le jury valide le précédent, pb barre UE, attente') ),
( ((ATB,), False, ALL, ALL, ALL, True),
  (ATJ, (AJ,), ADJ, None, None, 'Le jury valide le précédent, mais probleme assiduité.') ),
