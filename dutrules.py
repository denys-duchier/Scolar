...
#
# Command: ./csv2rules.py /tmp/parcoursDUT-2008-3.csv
# 
from sco_codes_parcours import *

rules_source_file='/tmp/parcoursDUT-2008-3.csv'
...
( '500', ((None, ADM, ADC, ADJ), True, False, ALL, False, ALL),
  (AJ, (), None, REDOSEM, None, 'Pas moy: redouble ce semestre') ),
( '510', ((None, ADM, ADC, ADJ), True, True, False, False, ALL),
  (AJ, (), None, REDOSEM, None, 'Pas barre UE: redouble ce semestre') ),
( '520', ((None, ADM, ADC, ADJ), False, ALL, ALL, ALL, ALL),
