...
def formsemestre_pagebulletin_dialog(context, REQUEST=None,
    ...
    form = [
        ...
        ('left_margin', {'size' : 20, 'title' : 'Marge gauche', 'type' : 'float' }),
        ('top_margin', {'size' : 20, 'title' : 'Marge haute', 'type' : 'float' }),
        ('right_margin', {'size' : 20, 'title' : 'Marge droite', 'type' : 'float' }),
        ('bottom_margin', {'size' : 20, 'title' : 'Marge basse', 'type' : 'float' }),
        ('sep', { 'input_type' : 'separator',
